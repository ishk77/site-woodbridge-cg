export const SITE = {
  ...
  email: "hello@woodbridgecg.com",
  phone: "(703) 000-0000",
  locations: ["Woodbridge, VA", "Philadelphia, PA"] as const,
  socials: {
    // Placeholder — replace with actual LinkedIn URL before launch
    linkedin: "https://linkedin.com/company/woodbridgecg",
  },
} as const
